...
test('image workbench exposes safe models and tasks, validates IDs and preserves idempotency without auth', async () => {
...
test('unexpected submission errors retain the valid task ID, while explicit validation failures do not', async () => {
