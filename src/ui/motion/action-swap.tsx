      ...
      >
        {cascade
          ? label.split('').map((char, index) => (
              <span
                // eslint-disable-next-line react/no-array-index-key -- position is the slot identity.
                key={index}
              ...
              <AnimatePresence initial={false}>
                ...
                >
                  {label.split('').map((char, i) => (
                    <motion.span
                      // eslint-disable-next-line react/no-array-index-key -- the letter at a position is exactly what rolls.
                      key={i}
